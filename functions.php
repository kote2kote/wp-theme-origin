...
if ( ! function_exists( 'origin_setup' ) ) :
	...
	function origin_setup() {
		...
		register_nav_menus( array(
			'common_header' => esc_html__( '共通ヘッダー', 'origin' ),
    	'common_footer' => esc_html__( '共通フッター', 'origin' ),
		) );
...
function origin_scripts() {
  ...
  date_default_timezone_set('Asia/Tokyo');
	...
	//CSS
	wp_enqueue_style( 'origin-style', get_stylesheet_uri(), array(), $id );

	//JavaScript
	wp_enqueue_script( 'origin-navigation', '//cdn.jsdelivr.net/npm/vue/dist/vue.js', '', array(), $id, false);
	wp_enqueue_script( 'origin-navigation', get_template_directory_uri() . '/js/navigation.js', array(), $id, true );
	wp_enqueue_script( 'origin-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), $id, true );
	wp_enqueue_script( 'origin-script-app', get_template_directory_uri() . '/assets/js/script.min.js', array(), $id, true );
